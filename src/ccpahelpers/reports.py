...
def get_header() -> str:
    header = (
        ...
        "exceed CCPA standards. While this helper automates many processes of data anonymization, "
...
def ner_report(report: dict):
    ...
    # Explicitly add the SSN column to the entities_detected
    df.loc[df['column_name'] == 'SSN', 'entities_detected'] = 'SSN'
...
def synthesis_report(report: dict):
    ...
    if "Enabled" in report["privacy_protection_level"].values():
        ppl_text = (
            ...
            "against privacy attacks, in compliance with CCPA."
        )
    else:
        ppl_text = (
    ...
    if report["summary"][0]["value"] > 80:
        acc_text = (
            ...
            "that it is based on, in compliance with CCPA."
        )
    ...
    md_content = (
        ...
        # f"Model training time: {report['training_time_seconds']} seconds\n\n"
    ...
    html_content = (
        ...
        # f"Model training time: {report['training_time_seconds']} seconds<br>"
